...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    # python3.dll is redirect wrapper often used by libraries so we need it
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        file(COPY "${CURRENT_PACKAGES_DIR}/bin/python3.dll" DESTINATION "${CURRENT_PACKAGES_DIR}/tools/${PORT}/")
    endif()
